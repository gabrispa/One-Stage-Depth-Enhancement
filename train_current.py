...
scale = 2
# DATASET USED --> THIS SCRIPT IS USED BOTH FOR NYU AND METAGRASP
dataset_name = 'MG'
...
for epoch in range(start_epoch, max_epoch):
    ...
    for idx, data in enumerate(t):
        ...
        if float(version) > 0.0:
            ...
            # GRADIENT LOSS WITH GT INPAINTING
   ...
   # VALIDATION
    with torch.no_grad():
        ...
        for idx, data in enumerate(t):  
            ...
            # CENTER CROP FOR METAGRASP FOR MEMORY REASONS
            if dataset_name == 'MG':
            ...
            # TWO DIFFERENT FUNCTIONS FOR RMSE BECAUSE METAGRASP HAS GLOBAL MAXIMUM RESCALING, NYU IS RESCALED USING MINMAX OF 
            # EACH IMAGE
            if dataset_name == 'MG':
